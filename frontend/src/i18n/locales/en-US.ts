export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      graphSourceFilterPlaceholder: 'Filter by source documents',
      graphSourceFilterTip: 'Filters an approximate local graph using Wiki page source references. A source contributed to a page, but does not prove that it produced every edge.',
      graphSourceFilterLimit: 'Select at most {count} source documents',
      graphScopedSources: '{count} source documents selected',
      ...
      graphScopedNoData: 'No Wiki pages or links match the selected source documents. Adjust the source scope.',
      graphScopedPageUnavailable: 'This page is outside the current source-document scope.',
      ...
      cardScopedOverviewTitle: 'Local graph',
