export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      graphSourceFilterPlaceholder: '出典ドキュメントで絞り込み',
      graphSourceFilterTip: 'Wikiページの出典参照に基づき、近似したローカルグラフを絞り込みます。出典はページの作成に寄与していますが、すべての辺を生成したことの証明にはなりません。',
      graphSourceFilterLimit: '出典ドキュメントは最大 {count} 件まで選択できます',
      graphScopedSources: '出典ドキュメントを {count} 件選択中',
      ...
      graphScopedNoData: '選択した出典ドキュメントに一致するWikiページやリンクがありません。出典の範囲を調整してください。',
      graphScopedPageUnavailable: 'このページは現在の出典ドキュメントの範囲外です。',
      showArrows: '矢印を表示',
      hideArrows: '矢印を非表示',
      ...
      cardScopedOverviewTitle: 'ローカルグラフ',
  ...
  chat: {
    ...
    answerExport: {
      buttonTitle: '回答をエクスポート',
      word: 'Word (.docx)',
      markdown: 'Markdown (.md)',
      emptyContent: '回答が空のためエクスポートできません',
      success: 'エクスポートが完了し、ダウンロードを開始しました',
      failed: 'エクスポートに失敗しました。再試行してください',
      docLabels: {
        question: '質問',
        answer: '回答',
        sources: '引用元',
        unresolvedCitation: '未照合の出典',
        imageLabel: '画像'
      }
    },
