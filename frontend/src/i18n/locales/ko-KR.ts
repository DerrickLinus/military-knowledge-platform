export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      graphSourceFilterPlaceholder: '출처 문서로 필터링',
      graphSourceFilterTip: 'Wiki 페이지의 출처 참조를 사용해 근사 로컬 그래프를 필터링합니다. 출처가 페이지 생성에 참여했음을 뜻하지만 모든 간선을 직접 생성했다는 증거는 아닙니다.',
      graphSourceFilterLimit: '출처 문서는 최대 {count}개까지 선택할 수 있습니다',
      graphScopedSources: '출처 문서 {count}개 선택됨',
      ...
      graphScopedNoData: '선택한 출처 문서와 일치하는 Wiki 페이지 또는 링크가 없습니다. 출처 범위를 조정하세요.',
      graphScopedPageUnavailable: '이 페이지는 현재 출처 문서 범위에 포함되지 않습니다.',
      showArrows: '화살표 표시',
      hideArrows: '화살표 숨기기',
      ...
      cardScopedOverviewTitle: '로컬 그래프',
