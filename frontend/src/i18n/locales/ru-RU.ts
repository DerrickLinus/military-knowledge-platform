export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      graphSourceFilterPlaceholder: 'Фильтр по исходным документам',
      graphSourceFilterTip: 'Фильтрует приблизительный локальный граф по ссылкам на источники Wiki-страниц. Источник участвовал в создании страницы, но не обязательно породил каждое ребро.',
      graphSourceFilterLimit: 'Можно выбрать не более {count} исходных документов',
      graphScopedSources: 'Выбрано исходных документов: {count}',
      ...
      graphScopedNoData: 'Для выбранных исходных документов нет связанных Wiki-страниц или ссылок. Измените область источников.',
      graphScopedPageUnavailable: 'Эта страница не входит в текущую область исходных документов.',
      ...
      cardScopedOverviewTitle: 'Локальный граф',
