export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      graphSourceFilterPlaceholder: '按来源资料筛选（可多选）',
      graphSourceFilterTip: '根据 Wiki 页面的来源引用筛选近似局部图谱；它表示资料参与了页面生成，不代表每条边都由该资料直接产生。',
      graphSourceFilterLimit: '最多选择 {count} 份资料',
      graphScopedSources: '已选 {count} 份来源资料',
      ...
      graphScopedNoData: '所选资料暂无关联 Wiki 页面或页面间链接，请调整来源资料范围',
      graphScopedPageUnavailable: '该页面不属于当前来源资料范围',
      showArrows: '显示箭头',
      hideArrows: '隐藏箭头',
